...
def find_clusters_sets(circle):
    '''
    function to find the cluster with the given ctuple circle cordinates list
    returns:
    '''
...
def checkOverlap(c1,c2):
    ...
    match the overlapping criteria distance <= r1 + r2
    ...
    # return true if circle overlaps
